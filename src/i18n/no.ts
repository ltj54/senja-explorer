const no = {
  ...
  about: {
    ...
    airbnbLinks: ['Hytte 1 – se annonse på Airbnb', 'Hytte 2 – se annonse på Airbnb'],
  },
  homeSeasonBoxes: {
    winter: {
  ...
  accommodation: {
    ...
    homeLinks: ['Utleiehytte 1 – se annonse på Airbnb', 'Utleiehytte 2 – se annonse på Airbnb'],
    links: ['Se hytte 1 på Airbnb', 'Se hytte 2 på Airbnb'],
  },
  summerPage: {
    ...
    experiences: {
      ...
      items: [
        {
          title: 'Båtturer og badestopp',
          description: 'Rolige turer til fine strender og lune steder langs kysten.',
        },
        {
    ...
    experiences: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'En enkel og nær opplevelse på fjorden, med god tid, lokal kunnskap og ofte fangst.',
        },
        {
          title: 'Praktisk inkludert',
  ...
  contactForm: {
    ...
    title: 'Kontakt Roland',
    name: 'Ditt navn',
    email: 'Din e-post',
    message: 'Din melding til Roland',
    submit: 'Send melding',
    sending: 'Sender…',
