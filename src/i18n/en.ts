const en = {
  ...
  about: {
    ...
    description:
      'Senja Explorer & Services is run by Roland Henriksen. With local knowledge of the nature, weather and partners on Senja, he can contribute with personal experiences and practical arrangements.',
  },
  summerPage: {
